...
```{r beer_plot}
top25_beer <- drinks %>% 
  top_n(n=25, wt = beer_servings)
  ggplot(top25_beer, aes(x = beer_servings, y=reorder(country, beer_servings)))+
    geom_col()+
    theme_bw()+
    labs(title="Top 25 Beer Consuming Countries", subtitle = "Data Since 2010", x="", y="Number Of Servings")
```
...
```{r wine_plot}
top25_wine <- drinks %>% 
  top_n(n=25, wt = wine_servings)
  ggplot(top25_wine, aes(x = wine_servings, y=reorder(country, wine_servings)))+
    geom_col()+
    theme_bw()+
    labs(title="Top 25 Wine Consuming Countries", subtitle = "Data Since 2010", x="", y="Number Of Servings")
...
```{r spirit_plot}
top25_spirit <- drinks %>% 
  top_n(n=25, wt = spirit_servings)
  ggplot(top25_spirit, aes(x = spirit_servings, y=reorder(country, spirit_servings)))+
    geom_col()+
    theme_bw()+
    labs(title="Top 25 Spirit Consuming Countries", subtitle = "Data Since 2010", x="", y="Number Of Servings")
